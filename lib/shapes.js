...
//Shapes construtor that passes in shape color, text color and text string
class Shape {
    ...
    //Render function that creates the main body of the shape. 
    render(){
...
//Class that extends shape, that creates the triangle
...
//Class that extends shape, that creates the circle
...
//Module Exports that allows each class to be called. 
module.exports = {
    Shape,
    Triangle,
    Circle,
